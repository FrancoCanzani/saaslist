...
export function ProductShare({
  ...
  const shareButtons = [
    ...
    },
    {
      ...
      href: `https://bsky.app/intent/compose?text=${encodeURIComponent(`${shareText} ${productUrl}`)}`,
    },
    {
      name: "Mastodon",
      icon: (
      ...
      href: `https://mastodon.social/share?text=${encodeURIComponent(`${shareText} ${productUrl}`)}`,
    },
    {
      name: "Facebook",
      icon: (
    ...
    },
    {
      ...
      href: `https://news.ycombinator.com/submitlink?u=${encodeURIComponent(productUrl)}&t=${encodeURIComponent(productName)}`,
    },
    {
      name: "Reddit",
      icon: (
      ...
      href: `https://www.reddit.com/submit?url=${encodeURIComponent(productUrl)}&title=${encodeURIComponent(productName)}`,
    },
    {
      name: "WhatsApp",
      icon: (
