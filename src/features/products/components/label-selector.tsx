...
export function LabelSelector({ selectedTags, onTagsChange, maxTags = 3 }: LabelSelectorProps) {
        ...
        <DialogContent className="max-w-3xl max-h-[80vh] flex flex-col p-0">
          <DialogHeader className="px-6 pt-6 pb-4 border-b">
            <div className="flex items-center justify-between">
              <DialogTitle className="text-xl font-semibold">Select launch tags</DialogTitle>
